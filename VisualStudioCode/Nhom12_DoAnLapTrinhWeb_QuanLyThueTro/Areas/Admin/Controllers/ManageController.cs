...
namespace Nhom12_DoAnLapTrinhWeb_QuanLyThueTro.Areas.Admin.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ActionResult IndexLoaiPhong()
        {
        ...
        public ActionResult CreateLoaiPhong()
        {
            if (Request.Form.Count > 0)
            {
                ...
                LoaiPhong g = new LoaiPhong();
                g.TenLoaiPhong = Request.Form["TenLoaiPhong"];                
                context.LoaiPhongs.InsertOnSubmit(g);
        ...
        {
            QuanLyWebThueTroDataContext context = new QuanLyWebThueTroDataContext();
            LoaiPhong p = context.LoaiPhongs.FirstOrDefault(x => x.ID == id);
            if (p != null)
            {
                context.LoaiPhongs.DeleteOnSubmit(p);
                context.SubmitChanges();
            }
            return RedirectToAction("Index");
        }
        public ActionResult EditLoaiPhong(int id)
        {
            ...
            p.TenLoaiPhong = Request.Form["TenLoaiPhong"];
            context.SubmitChanges();
            return RedirectToAction("Index");
        }
        //
